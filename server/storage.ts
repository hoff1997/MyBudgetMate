...
export class MemStorage implements IStorage {
  ...
  private initializeSampleData() {
    // Create demo user only - user will create their own accounts and transactions
    ...
    // Skip transaction creation - user will create their own transactions

    // Skip debt demo data creation - user will add their own debts if needed
